...
namespace miner {
    ...
    class DeviceRecords {
        ...
        Entry _traversedNonces;
        Entry _failedShareVerifications;

    public:
        const Entry &getTraversedNonces() const;
        const Entry &getFailedShareVerifications() const;
        ...
        void merge(const DeviceRecords &);
    };
